    ...
    dispatch(type, payload = {}) {
        ...
        switch (type) {
            ...
            case AvatarEvents.NOTIFY:
                // [v4.2] Standardized Notification via MessageBroker SPEAK event
                if (window.messageBroker) {
                    window.messageBroker.broadcast('SPEAK', { 
                        text: payload.message || "Command Received", 
                        visualType: 'system',
                        skip_tts: payload.skip_tts !== undefined ? payload.skip_tts : true 
                    });
                }
                break;
            default:
