...
export default {
    ...
    init: async function (root, context) {
        ...
        const pluginListEl = root.getElementById('plugin-list');
        const saveBtn = root.getElementById('save-config-btn');
        const saveStatus = root.getElementById('save-status');
        ...
        saveBtn.onclick = async () => {
            const selected = [];
            root.querySelectorAll('.plugin-item input:checked').forEach(cb => {
