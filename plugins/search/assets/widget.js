...
export default {
    init: function (root, context) {
        ...
        // UI Elements
        const win = root.getElementById('notion-search-window');
        const header = root.getElementById('search-window-header');
        const resizeHandle = root.getElementById('search-window-resize');
        const closeBtn = root.getElementById('search-close-btn');
        const statusEl = root.getElementById('search-status');
        const listEl = root.getElementById('search-results-list');
