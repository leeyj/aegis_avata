...
export default {
    ...
    init: async function (root, context) {
        ...
        const listContainer = root.getElementById('mp3-list');
        const audio = root.getElementById('mp3-audio');
        const info = root.getElementById('mp3-info');
        const aiBtn = root.getElementById('ai-analyze-btn');
        const aiRes = root.getElementById('ai-result');
